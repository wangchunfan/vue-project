        ...
        <div class="checkout-order">
            ...
            <div class="item-list-wrap confirm-item-list-wrap">
                <div class="cart-item order-item">
                    ...
                    <ul class="cart-item-list" v-for="(item,index) in cartList" :key="'cartList'+index" v-if="item.checked==1">
                        <li>
                            <div class="cart-tab-1">
                                <div class="cart-item-pic">
                                    <img v-bind:src=" '/static/'+ item.productImage" alt="item.productNmae">
                                </div>
        ...
        init() {
            axios.get("/users/cartList").then(res => {
                ...
                if (result.result) {
                    ...
                    this.subtotal = this.cartList.reduce(function (total, item) {
                        return (
                            total + (item.checked == 1 ? item.salePrice * item.productNum : 0)
                        );
                    }, 0);
                    this.orderTotal =
